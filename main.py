...
class PrisonersDilemma:
    ...
    def __init__(self, strategy_a=None, strategy_b=None):
        ...
        self.strategy_a = strategy_a or generated_strategies[0]
        self.strategy_b = strategy_b or generated_strategies[1]
        self.a_name = self.strategy_a.__name__
        self.b_name = self.strategy_b.__name__
    ...
    def play_round(self):
        ...
        '''
        try:
            strategy_a_result = self.strategy_a.main(self.a_name, self.b_name, self.history)
            strategy_b_result = self.strategy_b.main(self.a_name, self.b_name, self.history)
            ...
            print "Could not play this round:", detail
    ...
    def report_stats(self):
        ...
        The total points scored this round is {total}.
        An optimal game would have had {optimal} points.
        '''.format(
            num_rounds=num_rounds, a=self.a_name, b=self.b_name,
